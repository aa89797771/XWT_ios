...
//    static func getCurrentKeysAndObjectsData(needSortArray : JSON, finishCallback : @escaping successHandler) -> Void{
//
//        // 数据源
...
//
//        for (_,sortObj) in needSortArray {
//            let sort = SortObjectModel()
//            sort.objValue = sortObj["name"].stringValue
//            sort.imgUrl = sortObj["url"].stringValue
